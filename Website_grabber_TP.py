...
#    cookies = {1: {'sid': 'f4c7fb19cdfd91d9cb27ec1b9536d630'},  # session id, for connection to be valid (Mozilla)
#           2: {'sid': '06cf875c8fc29e530db5e7b7b6642968'}}  # 1: Casino X; 2: JoyCasino
