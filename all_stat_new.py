...
if __name__ == '__main__':
    ...
    #update_users(1) #They are commented out
    #update_trans(1) #They are commented out
    #update_mailings(1) #They are commented out
    #update_games(1) #They are commented out
    update_bonuses(1)
    #update_users(2) #They are commented out
    #update_trans(2) #They are commented out
    #update_mailings(2) #They are commented out
    #update_games(2) #They are commented out
    update_bonuses(2)
# по 99-му проекту все эти обновления происходят с помощью скрипта stat_update_fonbet.py
    #update_users(3)
    #update_trans(3)
    #update_mailings(3)
    #update_games(3)
